...
4. Choose depth from confirmed quality requirements, applicable `Required` or `Accepted` scoped technology entries, project risk, and the project's real unit, service, API, or end-to-end test setup.
